      ...
      <div className="flex-1 overflow-y-auto p-6">
        {activeTab === 'tickets' ? (
          ...
          <div>
            ...
            <div className="mb-4 flex items-center justify-between">
              <div className="text-sm text-gray-600">
                {selectedCategories.length} of {articleCategories.length} categories selected
              </div>
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className={`inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-medium ${getStatusColor(ticket.status)}`}>
                {ticket.status}
              </span>
              <span className={`inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-medium ${getPriorityColor(ticket.priority)}`}>
                {ticket.priority}
              </span>
            </div>
...
function ArticleCategoryCard({ 
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div className="flex h-6 w-6 items-center justify-center rounded bg-blue-100 flex-shrink-0 text-sm">
            📚
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-medium text-gray-900 truncate">{category.name}</h4>
              <span className="inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-medium bg-gray-100 text-gray-800">
